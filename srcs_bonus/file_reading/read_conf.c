...
/*   Updated: 2021/04/30 17:27:20 by pmira-pe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	file_conf(char *buff, t_map *flnf)
{
	...
	i += elem_check(ft_strncmp("F ", buff, 2), buff, flnf, 5);
	i += elem_check(ft_strncmp("C ", buff, 2), buff, flnf, 6);
	i += elem_check(ft_strncmp("S ", buff, 2), buff, flnf, 7);
	if (i < 9)
		return (0);
	return (1);
}
